__attribute__((section(".symbol_table"))) const char APP_SYM_TABLE[] =
	"00015848 T ADC_IRQHandler\n"
	"00015de4 T CAN_IRQHandler\n"
	"00015774 T EINT3_IRQHandler\n"
	"00015ce8 T I2C2_IRQHandler\n"
	"00015574 T RIT_IRQHandler\n"
	"00014974 T RTC_IRQHandler\n"
	"00010504 T TIMER1_IRQHandler\n"
	"00015a8c T UART0_IRQHandler\n"
	"00015a24 T UART2_IRQHandler\n"
	"000159bc T UART3_IRQHandler\n"
	...
	"00015c6c T I2C2::init(unsigned int)\n"
	"00015cd4 T I2C2::I2C2()\n"
	"00015cd4 T I2C2::I2C2()\n"
	"00015a70 T Uart0::Uart0()\n"
	"00015a70 T Uart0::Uart0()\n"
	"00015a08 T Uart2::Uart2()\n"
	"00015a08 T Uart2::Uart2()\n"
	"000159a0 T Uart3::Uart3()\n"
	"000159a0 T Uart3::Uart3()\n"
	"0001553c T CharDev::CharDev()\n"
	"0001553c T CharDev::CharDev()\n"
	"0001555c T CharDev::~CharDev()\n"
	"0001555c T CharDev::~CharDev()\n"
	"00014222 T Storage::read(char const*, void*, unsigned int, unsigned int)\n"
	"00015450 T UartDev::handleInterrupt()\n"
	"000153c4 T UartDev::flush()\n"
	"000153e4 T UartDev::getChar(char*, unsigned int)\n"
	"00015340 T UartDev::putChar(char, unsigned int)\n"
	"00015510 T UartDev::UartDev(unsigned int*)\n"
	"00015510 T UartDev::UartDev(unsigned int*)\n"
	"00015058 T I2C_Base::readRegisters(unsigned char, unsigned char, unsigned char*, unsigned long)\n"
	"0001507a T I2C_Base::writeRegisters(unsigned char, unsigned char, unsigned char*, unsigned long)\n"
	"0001530c T I2C_Base::handleInterrupt()\n"
	"00015194 T I2C_Base::i2cStateMachine()\n"
	"00015098 T I2C_Base::checkDeviceResponse(unsigned char)\n"
	"00015100 T I2C_Base::init(unsigned long, unsigned long)\n"
	"00015060 T I2C_Base::readReg(unsigned char, unsigned char)\n"
	"00014f80 T I2C_Base::transfer(unsigned char, unsigned char, unsigned char*, unsigned long)\n"
	"00015082 T I2C_Base::writeReg(unsigned char, unsigned char, unsigned char)\n"
	"000150b0 T I2C_Base::I2C_Base(LPC_I2C_TypeDef*)\n"
	"000150b0 T I2C_Base::I2C_Base(LPC_I2C_TypeDef*)\n"
	...
	"000175d0 T DACDriver::DAC_conversion(unsigned short)\n"
	"000174f8 T DACDriver::initDAC(DACDriver::DAC_PIN, bool)\n"
	"000174f4 T DACDriver::DACDriver()\n"
	"000174f4 T DACDriver::DACDriver()\n"
	"000174f6 T DACDriver::~DACDriver()\n"
	"000174f6 T DACDriver::~DACDriver()\n"
	"000142bc T IR_Sensor::storeIrCode(unsigned long)\n"
	"000142d8 T IR_Sensor::decodeIrCode()\n"
	"0001433c T IR_Sensor::init()\n"
	"000178b0 T std::type_info::__is_pointer_p() const\n"
	"000178b0 T std::type_info::__is_function_p() const\n"
	"000178b4 T std::type_info::operator==(std::type_info const&) const\n"
	"000178ae T std::type_info::~type_info()\n"
	"000178ae T std::type_info::~type_info()\n"
	"00017d6c T std::get_terminate()\n"
	"00017d7c T std::terminate()\n"
	"000189fc T abort\n"
	"00015904 T adc0_get_reading\n"
	"00015890 T adc0_init\n"
	"00018a0a T atoi\n"
	...
	"00015e20 T pxPortInitialiseStack\n"
	"0001a790 T raise\n"
	"0001a3ec T rand\n"
	"000135d4 T rcvr_datablock\n"
	"00015590 T rtc_gettime\n"
	"00015640 T rtc_init\n"
	"000155d8 T rtc_settime\n"
	...
	"0001a7c8 T siprintf\n"
	"0001a810 T siscanf\n"
	"00015b8c T spi1_lock\n"
	"00015bbc T spi1_unlock\n"
	"0001a7c8 T sprintf\n"
	"0001a39c T srand\n"
	"0001a810 T sscanf\n"
	"00015ab0 T ssp1_dma_init\n"
	"00015acc T ssp1_dma_transfer_block\n"
	"0001a8ee T strcmp\n"
	"0001a902 T strcpy\n"
	"0001a912 T strlen\n"
	"0001a922 T strncmp\n"
	...
	"00014cf0 T sys_set_inchar_func\n"
	"00014ce4 T sys_set_outchar_func\n"
	"00014d24 T syscalls_init\n"
	"0001b718 T time\n"
	...
	"0001bbfc T vsniprintf\n"
	"0001bbfc T vsnprintf\n"
